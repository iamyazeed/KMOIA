    ...
    return (
      <>
        <Button
          ...
          size="sm"
          disabled={pending}
          onClick={() => run(() => restoreCollectionItem(collection, id))}
        >
          <RotateCcw />
          Restore
        </Button>
  ...
  return (
    <>
      ...
      <Modal open={confirming} onOpenChange={setConfirming}>
        <ModalContent
          title="Move to trash?"
          description="It disappears from the website immediately. Nothing is destroyed — restore it from the Trash tab."
          footer={
            <>
              ...
              <Button
                disabled={pending}
                onClick={() => run(() => deleteCollectionItem(collection, id))}
